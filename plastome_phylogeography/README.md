=== Methods ===
Note: `$PHYLOGENOMICS` refers to [https://github.com/daisieh/phylogenomics this repository].

== Sampling ==
The master sample list used for this paper is [https://github.com/daisieh/reproducibility/blob/plastome-phylogeography/plastome_phylogeography/all_samples.txt all_samples.txt]. This file contains the names used to refer to the samples throughout, as well as their provenances, species IDs, and paths on the POPCAN servers.

== Overview phylogeny ==
A subset of samples, representing the within-species diversity as well as the relative phylogenetic position of the plastomes of the species, was piled up against the Salix interior plastome (Genbank [http://www.ncbi.nlm.nih.gov/nuccore/KJ742926 KJ742926]) using the `pileup_analysis.sh` script:
